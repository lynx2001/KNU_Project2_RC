...
# stm32 python sdk
# ─────────────────────────────────────────────────────────────────────────────
# Hiwonder ROS Robot Control Board (STM32F407VET6) 정품 시리얼 SDK.
# 사용자가 제공한 ros_robot_controller_sdk.py 를 그대로 벤더링한 것이다(원본 유지).
# 프로토콜: 0xAA 0x55 <func> <len> <data...> <crc8>,  baud=1,000,000
# stm32_bridge_node 가 이 Board 클래스를 import 해서 사용한다.
# ─────────────────────────────────────────────────────────────────────────────
import enum
import time
import copy
